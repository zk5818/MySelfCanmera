...
public class CustomCameraPreview extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    public void changeLight() {
        if (mCamera != null) {
            try {
                ...
                mParameters.setFlashMode(isLightOn ? Camera.Parameters.FLASH_MODE_OFF : Camera.Parameters.FLASH_MODE_TORCH);
